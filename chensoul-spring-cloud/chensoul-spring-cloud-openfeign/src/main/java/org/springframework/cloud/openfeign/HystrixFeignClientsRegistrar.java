...
/**
 * <p>
 * loadbalance 自动配置功能内置基于 mica
 * </p>
 */
public class HystrixFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
    ...
    private void registerFeignClients(BeanDefinitionRegistry registry) {
        ...
        for (String className : feignClients) {
            try {
                ...
                registerClientConfiguration(registry, getClientName(attributes), attributes.get("interceptor"));
    ...
    /**
     * Return the class used by {@link SpringFactoriesLoader} to load interceptor
     * candidates.
     *
     * @return the factory class
     */
    private Class<?> getSpringFactoriesLoaderFactoryClass() {
        return HystrixFeignConfiguration.class;
    }
