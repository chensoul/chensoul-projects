...
/**
 * Repository interface for aggregated startup data.
 *
 * @param <T> type of startup
 * @author Eric Zhao
 */
public interface MetricsRepository<T> {
    ...
    /**
     * Save all startup to the storage repository.
     *
     * @param metrics startup to save
     */
    void saveAll(Iterable<T> metrics);

    /**
     * Get all startup by {@code appName} and {@code resourceName} between a period of
     * time.
     *
     ...
     * @return all startup in query conditions
     */
