...
public interface AuthService<R> {
     ...
     * @return the authorization user represent the current user, when the user is illegal, a null
     * value will return.
     */
    ...
    interface AuthUser {
         ...
         * privileges to the target, but to throw a RuntimeException to represent no authorization
         * is also a good way.
         * </p>
         *
