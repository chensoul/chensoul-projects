...
public class ClusterConfigController {
    ...
    @PostMapping("/interceptor/modify_single")
    public Result<Boolean> apiModifyClusterConfig(@RequestBody String payload) {
        ...
        try {
            ...
            logger.error("Error when modifying cluster interceptor", ex.getCause());
            return errorResponse(ex);
        } catch (Throwable ex) {
            logger.error("Error when modifying cluster interceptor", ex);
