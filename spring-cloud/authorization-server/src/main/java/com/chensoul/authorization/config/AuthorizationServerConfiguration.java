package com.chensoul.authorization.config;

import com.chensoul.authorization.support.Jwks;
...
//    private String rsaPrivateKey;
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient registeredClient = RegisteredClient
            ...
            .tokenSettings(TokenSettings.builder().accessTokenTimeToLive(Duration.ofHours(12)).refreshTokenTimeToLive(Duration.ofHours(1)).build())
            .build();
