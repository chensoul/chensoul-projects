...
import com.chensoul.authorization.captcha.service.InMemoryCaptchaService;
import com.chensoul.authorization.captcha.service.RedisCaptchaService;
 ...
 */
@Configuration
@ConditionalOnProperty(name = "authorization.service.enabled", havingValue = "true", matchIfMissing = true)
...
public class CaptchaConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(name = "authorization.service.enabled", havingValue = "true")
    ...
    @ConditionalOnProperty(name = "authorization.service.enabled", havingValue = "false", matchIfMissing = true)
