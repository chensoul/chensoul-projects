...
import static com.chensoul.util.function.FunctionUtils.RETHROW_ALL;
import static com.chensoul.util.function.FunctionUtils.THROWABLE_TO_RUNTIME_EXCEPTION;
...
public interface CheckedPredicate<T> {
    ...
    static <T> Predicate<T> sneaky(CheckedPredicate predicate) {
        return unchecked(predicate, RETHROW_ALL);
    }

    static <T> Predicate<T> unchecked(CheckedPredicate predicate) {
        return unchecked(predicate, THROWABLE_TO_RUNTIME_EXCEPTION);
    }
