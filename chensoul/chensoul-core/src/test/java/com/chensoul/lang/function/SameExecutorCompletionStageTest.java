...
public class SameExecutorCompletionStageTest {
    ...
    public void testThenCombine() throws InterruptedException {
        ...
        BiFunction<Void, Void, Void> bf2 = CheckedBiFunction.unchecked((Void x, Void y) -> {
            latch2.await();
            return null;
        });
        ...
        BiFunction<Void, Void, Void> bf3 = CheckedBiFunction.unchecked((Void x, Void y) -> {
            latch3.await();
            return null;
        });
    ...
    public void testThenAcceptBoth() throws InterruptedException {
        ...
        BiConsumer<Void, Void> bf2 = CheckedBiConsumer.unchecked((Void x, Void y) -> {
            latch2.await();
        });
        ...
        BiConsumer<Void, Void> bf3 = CheckedBiConsumer.unchecked((Void x, Void y) -> {
            latch3.await();
        });
    ...
    public void testThenCompose() throws InterruptedException {
        ...
        Function<Void, CompletableFuture<Void>> fn2 = CheckedFunction.unchecked(x -> {
            latch2.await();
        ...
        Function<Void, CompletableFuture<Void>> fn3 = CheckedFunction.unchecked(x -> {
            latch3.await();
            return CompletableFuture.completedFuture(x);
        });
    ...
    public void testWhenComplete() throws InterruptedException {
        ...
        BiConsumer<Void, Throwable> bc2 = CheckedBiConsumer.unchecked((Void x, Throwable y) -> {
            latch2.await();
        });
        ...
        BiConsumer<Void, Throwable> bc3 = CheckedBiConsumer.unchecked((Void x, Throwable y) -> {
            latch3.await();
        });
    ...
    public void testHandle() throws InterruptedException {
        ...
        BiFunction<Void, Throwable, Void> bf2 = CheckedBiFunction.unchecked((Void x, Throwable y) -> {
            latch2.await();
            return null;
        });
        ...
        BiFunction<Void, Throwable, Void> bf3 = CheckedBiFunction.unchecked((Void x, Throwable y) -> {
            latch3.await();
            return null;
        });
    ...
    private <T> Function<T, T> latchIdentity(CountDownLatch latch) {
        return CheckedFunction.unchecked(t -> {
            latch.await();
            return t;
        });
    }
    ...
    private <T> Consumer<T> latchConsumer(CountDownLatch latch) {
        return CheckedConsumer.unchecked((x) -> latch.await());
    }

    private Runnable latchRunnable(CountDownLatch latch) {
        return CheckedRunnable.unchecked(() -> latch.await());
    }
