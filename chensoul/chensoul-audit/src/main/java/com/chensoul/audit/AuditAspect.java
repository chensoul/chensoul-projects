...
public class AuditAspect {
    ...
    private final List<com.chensoul.audit.AuditManager> AuditManagers;
    ...
    public AuditAspect(final String applicationCode,
                       final List<com.chensoul.audit.AuditManager> AuditManagers,
    ...
    public Object handleAudit(final ProceedingJoinPoint joinPoint, final com.chensoul.audit.Audit audit) throws Throwable {
    ...
    private String getCurrentPrincipal(final ProceedingJoinPoint joinPoint, final com.chensoul.audit.Audit audit, final Object retVal) {
    ...
    private void executeAuditCode(final ProceedingJoinPoint joinPoint, final String currentPrincipal, final String action, final String[] auditableResources,
        ...
        final com.chensoul.audit.AuditActionContext auditContext = new com.chensoul.audit.AuditActionContext(applicationCode, currentPrincipal, action, auditableResources,
            operateTime, success, exception, cost, clientInfo);

        try {
            for (final com.chensoul.audit.AuditManager manager : AuditManagers) {
