package com.chensoul.boot.properties.jpa;
...
public abstract class AbstractJpaProperties implements Serializable {
     ...
     * This is for "legacy" databases that do not resource the JDBC4 {@code Connection.isValid()} API.
     */
    ...
    /**
     * Additional settings provided by Hibernate (or the connection authentication) in form of key-value pairs.
     */
